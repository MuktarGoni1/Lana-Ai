...
function ChildRegisterFlow() {
  ...
  return (
    <FormWrapper>
      <FormCard>
        <form onSubmit={handleChild} suppressHydrationWarning className="space-y-6">
          <FormHeader 
            icon={User} 
            title="Student Registration" 
            subtitle="Get personalized lessons and quizzes"
          />
          ...
          <div className="space-y-4">
            ...
            <p className="text-xs text-white/20 text-center">
              We'll send you a secure login link to continue
            </p>
          </div>
...
function RegisterFormContent() {
  ...
  return (
    <AnimatePresence mode="wait">
      ...
      {role === "child" && <ChildRegisterFlow key="child" />}
      {!role && (
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
