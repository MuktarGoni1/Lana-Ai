      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-4 sm:gap-6 md:grid-cols-2 lg:grid-cols-3 md:gap-8">
          {features.map((f, index) => (
            <div 
              key={f.title} 
              className="rounded-xl border bg-card p-6 shadow-sm transition-all duration-300 hover:shadow-xl hover:border-primary/60 hover:-translate-y-2 dark:hover:shadow-blue-500/30 dark:hover:shadow-xl"
            >
    ...
    <section className="py-16 md:py-24 lg:py-32 bg-transparent">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 md:mb-16">
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mt-3 text-foreground">Organized Lessons for Better Learning</h2>
          <p className="text-muted-foreground mt-4 max-w-2xl mx-auto text-base md:text-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center p-6 rounded-xl border bg-card shadow-sm transition-all duration-300 hover:shadow-xl hover:border-primary/60 hover:-translate-y-2 dark:hover:shadow-blue-500/30 dark:hover:shadow-xl">
            <BookOpen className="h-12 w-12 text-primary mx-auto mb-4 dark:text-blue-400 dark:hover:text-blue-300" />
            <h3 className="text-xl font-semibold mb-2 text-foreground">Step-by-Step Approach</h3>
            <p className="text-muted-foreground">Lessons are carefully structured to build upon each other, ensuring solid understanding.</p>
          </div>
          <div className="text-center p-6 rounded-xl border bg-card shadow-sm transition-all duration-300 hover:shadow-xl hover:border-primary/60 hover:-translate-y-2 dark:hover:shadow-blue-500/30 dark:hover:shadow-xl">
            <GraduationCap className="h-12 w-12 text-primary mx-auto mb-4 dark:text-blue-400 dark:hover:text-blue-300" />
            <h3 className="text-xl font-semibold mb-2 text-foreground">Progressive Learning</h3>
            <p className="text-muted-foreground">Each lesson builds on previous knowledge, creating a solid foundation for advanced topics.</p>
          </div>
          <div className="text-center p-6 rounded-xl border bg-card shadow-sm transition-all duration-300 hover:shadow-xl hover:border-primary/60 hover:-translate-y-2 dark:hover:shadow-blue-500/30 dark:hover:shadow-xl">
            ...
            <p className="text-muted-foreground">Engaging activities and quizzes reinforce learning at each step of the way.</p>
          </div>
        </div>
      </div>
    </section>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-4 sm:gap-6 md:grid-cols-3 md:gap-8">
          {plans.map((p) => (
            <div
              key={p.name}
              className={`relative rounded-xl border bg-card p-8 shadow-sm transition-all duration-300 hover:shadow-xl hover:border-primary/60 hover:-translate-y-2 ${"popular" in p && p.popular ? "border-primary shadow-lg" : ""}`}
            >
    ...
    <section className="py-16 md:py-24 lg:py-32 bg-transparent">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 md:mb-16">
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mt-3 text-foreground">Proven Educational Methodology</h2>
          <p className="text-muted-foreground mt-4 max-w-2xl mx-auto text-base md:text-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          <div className="bg-card p-6 rounded-xl border shadow-sm transition-all duration-300 hover:shadow-xl hover:border-primary/60 hover:-translate-y-2 dark:hover:shadow-blue-500/30 dark:hover:shadow-xl">
            <div className="flex items-start gap-4">
              <div className="bg-primary/10 p-3 rounded-lg">
                <Bot className="h-6 w-6 text-primary dark:text-blue-400 dark:hover:text-blue-300" />
              </div>
              <div>
                <h3 className="text-xl font-semibold mb-2 text-foreground">AI-Powered Adaptation</h3>
                <p className="text-muted-foreground">The system adapts to each learner's pace and style, providing personalized content and challenges.</p>
              </div>
            </div>
          </div>
          <div className="bg-card p-6 rounded-xl border shadow-sm transition-all duration-300 hover:shadow-xl hover:border-primary/60 hover:-translate-y-2 dark:hover:shadow-blue-500/30 dark:hover:shadow-xl">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">Detailed insights help students, parents, and teachers monitor growth and identify areas for improvement.</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <section className="py-16 md:py-24 lg:py-32 bg-transparent">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 md:mb-16">
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mt-3 text-foreground">Structured Curriculum for Long-term Success</h2>
          <p className="text-muted-foreground mt-4 max-w-2xl mx-auto text-base md:text-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center p-6 rounded-xl border bg-card shadow-sm transition-all duration-300 hover:shadow-xl hover:border-primary/60 hover:-translate-y-2 dark:hover:shadow-blue-500/30 dark:hover:shadow-xl">
            ...
            <h3 className="text-xl font-semibold mb-2 text-foreground">Long-term Planning</h3>
            <p className="text-muted-foreground">Comprehensive curriculum plans spanning weeks and months to ensure steady progress.</p>
          </div>
          <div className="text-center p-6 rounded-xl border bg-card shadow-sm transition-all duration-300 hover:shadow-xl hover:border-primary/60 hover:-translate-y-2 dark:hover:shadow-blue-500/30 dark:hover:shadow-xl">
            <Zap className="h-12 w-12 text-primary mx-auto mb-4 dark:text-blue-400 dark:hover:text-blue-300" />
            <h3 className="text-xl font-semibold mb-2 text-foreground">Milestone Tracking</h3>
            <p className="text-muted-foreground">Clear checkpoints to measure achievement and adjust learning paths as needed.</p>
          </div>
          <div className="text-center p-6 rounded-xl border bg-card shadow-sm transition-all duration-300 hover:shadow-xl hover:border-primary/60 hover:-translate-y-2 dark:hover:shadow-blue-500/30 dark:hover:shadow-xl">
            <Lightbulb className="h-12 w-12 text-primary mx-auto mb-4 dark:text-blue-400 dark:hover:text-blue-300" />
            <h3 className="text-xl font-semibold mb-2 text-foreground">Flexible Adjustments</h3>
            <p className="text-muted-foreground">Adapt curriculum plans based on individual learning pace and evolving needs.</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section className="py-16 md:py-24 lg:py-32 bg-transparent">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 md:mb-16">
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mt-3 text-foreground">Expert Math Tutoring at Your Fingertips</h2>
          <p className="text-muted-foreground mt-4 max-w-2xl mx-auto text-base md:text-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          <div className="bg-card p-6 rounded-xl border shadow-sm transition-all duration-300 hover:shadow-xl hover:border-primary/60 hover:-translate-y-2 dark:hover:shadow-blue-500/30 dark:hover:shadow-xl">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-xl font-semibold mb-2 text-foreground">Step-by-Step Solutions</h3>
                <p className="text-muted-foreground">Understand how to solve problems with detailed explanations for each step.</p>
              </div>
            </div>
          </div>
          <div className="bg-card p-6 rounded-xl border shadow-sm transition-all duration-300 hover:shadow-xl hover:border-primary/60 hover:-translate-y-2 dark:hover:shadow-blue-500/30 dark:hover:shadow-xl">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-xl font-semibold mb-2 text-foreground">Visual Problem Solving</h3>
                <p className="text-muted-foreground">See diagrams and visual aids that clarify complex mathematical concepts.</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <section className="py-16 md:py-24 lg:py-32 bg-transparent">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 md:mb-16">
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mt-3 text-foreground">Quick Answers to Complex Topics</h2>
          <p className="text-muted-foreground mt-4 max-w-2xl mx-auto text-base md:text-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center p-6 rounded-xl border bg-card shadow-sm transition-all duration-300 hover:shadow-xl hover:border-primary/60 hover:-translate-y-2 dark:hover:shadow-blue-500/30 dark:hover:shadow-xl">
            <Lightbulb className="h-12 w-12 text-primary mx-auto mb-4 dark:text-blue-400 dark:hover:text-blue-300" />
            <h3 className="text-xl font-semibold mb-2 text-foreground">Concept Simplification</h3>
            <p className="text-muted-foreground">Complex topics broken down into simple, digestible explanations.</p>
          </div>
          <div className="text-center p-6 rounded-xl border bg-card shadow-sm transition-all duration-300 hover:shadow-xl hover:border-primary/60 hover:-translate-y-2 dark:hover:shadow-blue-500/30 dark:hover:shadow-xl">
            <Zap className="h-12 w-12 text-primary mx-auto mb-4 dark:text-blue-400 dark:hover:text-blue-300" />
            <h3 className="text-xl font-semibold mb-2 text-foreground">Immediate Help</h3>
            <p className="text-muted-foreground">Get answers to your questions without waiting for office hours.</p>
          </div>
          <div className="text-center p-6 rounded-xl border bg-card shadow-sm transition-all duration-300 hover:shadow-xl hover:border-primary/60 hover:-translate-y-2 dark:hover:shadow-blue-500/30 dark:hover:shadow-xl">
            ...
            <p className="text-muted-foreground">Help is available whenever you need it, day or night.</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section className="py-16 md:py-24 lg:py-32 bg-transparent">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 md:mb-16">
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mt-3 text-foreground">Additional Learning Tools</h2>
          <p className="text-muted-foreground mt-4 max-w-2xl mx-auto text-base md:text-lg">
            Explore additional features designed to enhance the learning experience.
          </p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <div className="text-center p-4 rounded-xl border bg-card shadow-sm transition-all duration-300 hover:shadow-xl hover:border-primary/60 hover:-translate-y-2 group dark:hover:shadow-blue-500/30 dark:hover:shadow-xl">
            ...
            <h3 className="font-semibold text-foreground">Progress Reports</h3>
          </div>
          <div className="text-center p-4 rounded-xl border bg-card shadow-sm transition-all duration-300 hover:shadow-xl hover:border-primary/60 hover:-translate-y-2 group dark:hover:shadow-blue-500/30 dark:hover:shadow-xl">
            <div className="bg-primary/10 p-3 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
...
export default function Home() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-gradient-to-br from-blue-50 via-indigo-50 to-cyan-50 dark:from-blue-900/20 dark:via-indigo-900/20 dark:to-cyan-900/20 text-foreground">
