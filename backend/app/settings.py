...
def load_settings() -> Settings:
    ...
    values = {
        ...
        "cors_origins": os.getenv(
            "CORS_ORIGINS",
            "http://localhost:3000,http://localhost:3001,https://lanamind.com,https://www.lanamind.com",
        ) or "http://localhost:3000,http://localhost:3001,https://lanamind.com,https://www.lanamind.com",
