...
def init_services():
    ...
    if lesson_service is None or tts_service is None:
        ...
        # Initialize services
        lesson_service = LessonService(cache_repository=cache_repo)
...
async def process_tts_job(job: Job, token: str) -> Dict[str, Any]:
    ...
    try:
        ...
        logger.info(f"Processing TTS job for text: {(text or '')[:50]}...")
